...
class Developer:
    def __init__(self,root):
        ...
        # Developer info
        dev_label = Label(main_frame,text="Hello! My name is Arman Hussain",font=("times new roman",13,"bold"))
        dev_label.place(x=0,y=20)

        dev_label = Label(main_frame,text="I am a Software Engineer",font=("times new roman",22,"bold"))
